    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-white/70">Manage posts, testimonies, news, and announcements</p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        ...
        <div className="relative">
          ...
          <select
            ...
            className="pl-10 pr-8 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 appearance-none"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white/5 ring-1 ring-white/10 rounded-lg p-4">
          <div className="text-2xl font-bold">{posts.filter(p => p.category === 'testimony').length}</div>
          <div className="text-white/70 text-sm">Testimonies</div>
        </div>
        <div className="bg-white/5 ring-1 ring-white/10 rounded-lg p-4">
          <div className="text-2xl font-bold">{posts.filter(p => p.category === 'news').length}</div>
          <div className="text-white/70 text-sm">News Articles</div>
        </div>
        <div className="bg-white/5 ring-1 ring-white/10 rounded-lg p-4">
          <div className="text-2xl font-bold">{posts.filter(p => p.category === 'announcement').length}</div>
          <div className="text-white/70 text-sm">Announcements</div>
        </div>
      </div>
